...
export default function Header() {
    return (
        <header
            className="h-16 bg-white/80 backdrop-blur-md border-b border-gray-200 fixed top-0 right-0 left-0 md:left-64 z-10 px-8 flex items-center justify-between transition-all duration-300">
            <div className="flex items-center gap-4 w-full max-w-xl">
                <div className="relative w-full group">
                    ...
                    <input id="global-search" type="text" placeholder="Search ticker (e.g. NVDA, AAPL)..."
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-3 cursor-pointer hover:opacity-80 transition-opacity">
                    ...
                    <div
                        className="w-10 h-10 bg-gradient-to-tr from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-bold shadow-lg">
                        AM
                    </div>
                </div>
            </div>
